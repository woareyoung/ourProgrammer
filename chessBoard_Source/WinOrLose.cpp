...
bool ChessRule::Besieged(int RivalLine, int RivalColumn, int player, int rival)
{
    ...
    if(cross[RivalLine - 1][RivalColumn] == rival && RivalLine - 1 > 0 && Cross[RivalLine - 1][RivalColumn] == false)
    ...
    if(cross[RivalLine + 1][RivalColumn] == rival && RivalLine + 1 < 10 && Cross[RivalLine + 1][RivalColumn] == false)
    ...
    if(cross[RivalLine][RivalColumn + 1] == rival && RivalColumn + 1 < 10 && Cross[RivalLine][RivalColumn + 1] == false)
    ...
    if(cross[RivalLine][RivalColumn - 1] == rival && RivalColumn - 1 > 0 && Cross[RivalLine][RivalColumn - 1] == false)
